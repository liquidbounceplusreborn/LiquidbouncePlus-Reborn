            ...
            when {
                ...
                args[1].equals("category", true) -> {
                    if (args.size < 3) {
                        ...
                        return
                    } else if (LiquidBounce.moduleManager.modules.find { it.category.displayName.equals(args[2], true) } != null) {
                        LiquidBounce.moduleManager.modules.filter { it.category.displayName.equals(args[2], true) }.forEach { it.array = false }
