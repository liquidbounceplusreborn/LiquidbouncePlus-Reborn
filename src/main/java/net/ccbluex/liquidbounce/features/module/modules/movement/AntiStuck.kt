...
@ModuleInfo(name = "AntiStuck", description = "Unflags you", category = ModuleCategory.MOVEMENT)
    ...
    fun onUpdate(event: UpdateEvent) {
        if (stuck) {
            ...
            if (flagsTime> flagsValue.get()) {
                ...
                flagsTime = 0
                stuck = true
                LiquidBounce.hud.addNotification(Notification(name,"Trying to unstuck you", Type.INFO, 1500))
            }
