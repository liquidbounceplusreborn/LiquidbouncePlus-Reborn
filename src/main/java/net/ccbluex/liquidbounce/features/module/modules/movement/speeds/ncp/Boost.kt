    ...
    override fun onMotion() {
        ...
        if (ground == 1.0f && shouldSpeedUp()) {
            ...
            when (motionDelay) {
                ...
                4 -> {
                    if (shouldOffset) mc.thePlayer.setPosition(mc.thePlayer.posX + mc.thePlayer.motionX / offset, mc.thePlayer.posY, mc.thePlayer.posZ + mc.thePlayer.motionZ / offset)
                    motionDelay = 0
                }
            }
        }
