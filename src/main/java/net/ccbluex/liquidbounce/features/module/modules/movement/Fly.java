...
public class Fly extends Module {
    ...
    public void onEnable() {
        ...
        if (!mode.equalsIgnoreCase("blocksmc")
            ...
            case "blocksmc":
                ...
                if (event.getEventState() == EventState.PRE) {
                    ...
                    if (mc.playerController.onPlayerRightClick(
                        ...
                        EnumFacing.UP, 
                        RotationUtils.getVectorForRotation(RotationUtils.getRotationFromPosition(mc.thePlayer.posX, mc.thePlayer.posZ, (int)mc.thePlayer.posY - 0))))
    ...
    public void onPacket(PacketEvent event) {
        ...
        if (packet instanceof C09PacketHeldItemChange && mode.equalsIgnoreCase("blocksmc") && wdState < 4)
            event.cancelEvent();

        if (packet instanceof S08PacketPlayerPosLook) {
            if (mode.equalsIgnoreCase("blocksmc") && wdState == 3) {
                wdState = 4;
    ...
    public void onJump(final JumpEvent e) {
        ...
        if (mode.equalsIgnoreCase("Hypixel") || mode.equalsIgnoreCase("BoostHypixel") ||
                mode.equalsIgnoreCase("Rewinside") || (mode.equalsIgnoreCase("Mineplex") && mc.thePlayer.inventory.getCurrentItem() == null) || (mode.equalsIgnoreCase("FunCraft") && moveSpeed > 0) || (mode.equalsIgnoreCase("blocksmc") && wdState >= 1))
            e.cancelEvent();
    }
    ...
    public void onStep(final StepEvent e) {
        ...
        if (mode.equalsIgnoreCase("Hypixel") || mode.equalsIgnoreCase("BoostHypixel") ||
                mode.equalsIgnoreCase("Rewinside") || (mode.equalsIgnoreCase("Mineplex") && mc.thePlayer.inventory.getCurrentItem() == null) || mode.equalsIgnoreCase("FunCraft") || mode.equalsIgnoreCase("blocksmc"))
            e.setStepHeight(0F);
    }
