...
class KillAura : Module() {
    ...
    // AutoBlock
    private val autoBlockModeValue = ListValue("AutoBlock", arrayOf("None", "Packet", "AfterTick", "NCP", "OldHypixel", "Vanilla"), "None")
    ...
    override fun onEnable() {
        ...
        if (autoBlockModeValue.get().equals("Vanilla", true) && hitable)
