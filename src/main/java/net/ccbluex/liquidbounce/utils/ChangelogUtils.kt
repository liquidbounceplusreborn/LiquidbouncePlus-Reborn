...
object ChangelogUtils {
    ...
    fun update() {
        ...
        try {
            val s =
                HttpUtils.get("https://api.github.com/repos/liquidbounceplusreborn/LiquidbouncePlus-Reborn/actions/runs")
            ...
            builds.forEach { build ->
                ...
                if (!(buildMsg.contains("Merge branch") || buildMsg.length > 50))
