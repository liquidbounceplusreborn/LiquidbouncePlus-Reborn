...
public class MixinLayerHeldItem {
    ...
    public void doRenderLayer(EntityLivingBase entitylivingbaseIn, float p_177141_2_, float p_177141_3_, float partialTicks, float p_177141_5_, float p_177141_6_, float p_177141_7_, float scale) {
        ...
        if (itemstack != null) {
            ...
            if (entityplayer != null && entityplayer.isBlocking() || entityplayer != null && killAura.getTarget() != null && killAura.getBlockingStatus() && item instanceof ItemSword && Objects.equals(entityplayer.getGameProfile().getName(), Minecraft.getMinecraft().thePlayer.getGameProfile().getName())) {
