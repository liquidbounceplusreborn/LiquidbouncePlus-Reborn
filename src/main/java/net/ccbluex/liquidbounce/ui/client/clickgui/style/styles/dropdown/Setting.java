 ...
 */
package net.ccbluex.liquidbounce.ui.client.clickgui.style.styles.dropdown;
...
public class Setting {
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        if (setting instanceof FloatValue) {
            ...
            RenderUtils.drawRect(module.tab.getPosX() + 1, y + 3, module.tab.getPosX() + 1 + 98 * percent, y + 14, ClickGUI.generateColor());
        ...
        if (setting instanceof BoolValue) {
            ...
            if (boolValue.get()) {
                RenderUtils.drawCheck(module.tab.getPosX() + 91, y + 8.5f, 2, ClickGUI.generateColor().brighter().getRGB());
            }
        ...
        if (setting instanceof IntegerValue){}
          ...
          /*
            case BINDABLE:
                ...
                return mouseX >= module.tab.getPosX() + 97.5f - Fonts.fontSFUI35.stringWidth(key) && mouseX <= module.tab.getPosX() + 97.5f && mouseY >= y + 4 && mouseY <= y + 14;
