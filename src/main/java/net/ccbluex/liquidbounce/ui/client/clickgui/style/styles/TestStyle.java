...
public class TestStyle extends Style {
    ...
    public void drawPanel(int mouseX, int mouseY, Panel panel) {
        //RenderUtils.drawGradientSideways((float) panel.getX() - 3, (float) panel.getY(), (float) panel.getX() + panel.getWidth() + 3, (float) panel.getY() + 19, ClickGUI.generateColor().getRGB(),new Color(ClickGUI.generateColor().getRed(),ClickGUI.generateColor().getGreen(),ClickGUI.generateColor().getBlue(),50).getRGB());
        RenderUtils.drawGradientSideways((float) panel.getX() - 3, (float) panel.getY(), (float) panel.getX() + panel.getWidth() + 3, (float) panel.getY() + 19,new Color(0,0,0,150).getRGB() ,new Color(0,0,0,120).getRGB());
        if(panel.getFade() > 0)
        ...
        Fonts.fontSFUI35.drawString("§f" + panel.getName(), (int) (panel.getX() - (textWidth - 93.0F) / 2F), panel.getY() + 7, Integer.MAX_VALUE);
    }
    ...
    public void drawButtonElement(int mouseX, int mouseY, ButtonElement buttonElement) {
        GlStateManager.resetColor();
        Fonts.fontSFUI35.drawString(buttonElement.getDisplayName(), (int) (buttonElement.getX() - (Fonts.fontSFUI35.getStringWidth(buttonElement.getDisplayName()) - 100.0f) / 2.0f), buttonElement.getY() + 6, buttonElement.getColor());
    }
    ...
    public void drawModuleElement(int mouseX, int mouseY, ModuleElement moduleElement) {
        ...
        GlStateManager.resetColor();
        Fonts.fontSFUI35.drawString(moduleElement.getDisplayName(), moduleElement.getX()+3, moduleElement.getY() + 7, moduleElement.getModule().getState() ? guiColor : Integer.MAX_VALUE);
