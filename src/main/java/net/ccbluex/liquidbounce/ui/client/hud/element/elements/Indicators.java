...
public class Indicators extends Element {
    ...
    public final Color getColor(final int index) {
        switch (colorModeValue.get()) {
            ...
            case "Fade":
                return ColorUtils.fade(new Color(rRed.get(), rGreen.get(), rBlue.get()), index, 100);
        }
        return null;
    }
    ...
    public Border drawElement() {
        ...
        final float xX = scaledWidth / 2.0f;
        final float yX = scaledHeight / 2.0f;
        ...
        RenderUtils.drawNewRect(xX + 5, yX + 197 - 405, xX + 100, yX + 198 - 405, getColor(i).getRGB());
        ...
        RenderUtils.drawRect(xX + 44, yX + 210 - 406, xX + 44 + this.armorBarWidth, yX + 213.5 - 406, getColor(i).getRGB());
        ...
        RenderUtils.drawRect(xX + 44, yX + 219 - 406, xX + 44 + this.hurttimeBarWidth, yX + 222.5 - 406, getColor(i).getRGB());
        ...
        RenderUtils.drawRect(xX + 44, yX + 228 - 406, xX + 44 + this.bpsBarWidth, yX + 231.5 - 406, getColor(i).getRGB());
        ...
        RenderUtils.drawRect(xX + 44, yX + 237 - 406, xX + 44 + this.healthBarWidth, yX + 240.5 - 406, getColor(i).getRGB());
