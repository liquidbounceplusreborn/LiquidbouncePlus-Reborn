...
class GuiMainMenu : GuiScreen(), GuiYesNoCallback {
    ...
    override fun drawScreen(mouseX: Int, mouseY: Int, partialTicks: Float) {
        ...
        Fonts.fontSFUI40.drawStringWithShadow("${LiquidBounce.CLIENT_NAME} build ${LiquidBounce.CLIENT_VERSION} | lbpro.ml", 2F, height - 12F, -1)
        Fonts.fontSFUI40.drawStringWithShadow(creditInfo, width - 3F - Fonts.fontSFUI40.getStringWidth(creditInfo), height - 12F, -1)
    ...
    fun renderSwitchButton() {
        ...
        Fonts.fontSFUI40.drawStringWithShadow("Parallax", 28F, height - 25F, -1)
    ...
    fun renderBar(mouseX: Int, mouseY: Int, partialTicks: Float) {
        ...
        if (displayString != null)
            ...
            Fonts.fontSFUI35.drawCenteredString("Hope inf back again.", width / 2F, staticY + 30F, -1)
