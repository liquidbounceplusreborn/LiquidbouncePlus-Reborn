...
public class WhiteStyle extends Style {
    ...
    public void drawPanel(int mouseX, int mouseY, Panel panel) {
        ...
        Fonts.fontSFUI35.drawString(panel.getName(), (int) (panel.getX() - (textWidth - 100.0F) / 2F), panel.getY() + 7 - 3, Color.BLACK.getRGB());
    }
    ...
    public void drawDescription(int mouseX, int mouseY, String text) {
        ...
        RenderUtils.drawBorderedRect(mouseX + 9, mouseY, mouseX + textWidth + 14, mouseY + Fonts.fontSFUI35.FONT_HEIGHT + 3, 3F, new Color(217, 217, 217).getRGB(), new Color(217, 217, 217).getRGB());
        GlStateManager.resetColor();
        Fonts.fontSFUI35.drawString(text, mouseX + 12, mouseY + (Fonts.fontSFUI35.FONT_HEIGHT / 2), Color.BLACK.getRGB());
    }
    ...
    public void drawButtonElement(int mouseX, int mouseY, ButtonElement buttonElement) {
        ...
        Fonts.fontSFUI35.drawString(buttonElement.getDisplayName(), buttonElement.getX() + 5, buttonElement.getY() + 7, Color.BLACK.getRGB());
    }
    ...
    public void drawModuleElement(int mouseX, int mouseY, ModuleElement moduleElement) {
        ...
        GlStateManager.resetColor();
        Fonts.fontSFUI35.drawString(moduleElement.getDisplayName(), moduleElement.getX() + 5, moduleElement.getY() + 7, Color.BLACK.getRGB());

        // Draw settings
        final List<Value<?>> moduleValues = moduleElement.getModule().getValues();

        if (!moduleValues.isEmpty()) {
            Fonts.fontSFUI35.drawString("-", moduleElement.getX() + moduleElement.getWidth() - 8, moduleElement.getY() + 5, Color.BLACK.getRGB());
            ...
            if (moduleElement.isShowSettings()) {
                ...
                for (final Value value : moduleValues) {
                    ...
                    if (value instanceof BoolValue) {
                        ...
                        Fonts.fontSFUI35.drawString(text, moduleElement.getX() + moduleElement.getWidth() + 6, moduleElement.slowlySettingsYPos + 2, ((BoolValue) value).get() ? Color.BLACK.getRGB() : new Color(120, 120, 120).getRGB());
                        ...
                        Fonts.fontSFUI35.drawString(text, moduleElement.getX() + moduleElement.getWidth() + 6, moduleElement.slowlySettingsYPos + 2, 0xFF000000);
                        Fonts.fontSFUI35.drawString(listValue.openList ? "-" : "+", (int) (moduleElement.getX() + moduleElement.getWidth() + moduleElement.getSettingsWidth() - (listValue.openList ? 5 : 6)), moduleElement.slowlySettingsYPos + 2, 0xFF000000);

                        if (mouseX >= moduleElement.getX() + moduleElement.getWidth() + 4 && mouseX <= moduleElement.getX() + moduleElement.getWidth() + moduleElement.getSettingsWidth() && mouseY >= moduleElement.slowlySettingsYPos && mouseY <= moduleElement.slowlySettingsYPos + Fonts.fontSFUI35.FONT_HEIGHT && Mouse.isButtonDown(0) && moduleElement.isntPressed()) {
                        ...
                        for (final String valueOfList : listValue.getValues()) {
                            ...
                            if (listValue.openList) {
                                ...
                                GlStateManager.resetColor();
                                Fonts.fontSFUI35.drawString("- " + valueOfList, moduleElement.getX() + moduleElement.getWidth() + 6, moduleElement.slowlySettingsYPos + 2, listValue.get() != null && listValue.get().equalsIgnoreCase(valueOfList) ? Color.BLACK.getRGB() : new Color(120, 120, 120).getRGB());
                                moduleElement.slowlySettingsYPos += Fonts.fontSFUI35.FONT_HEIGHT + 1;
                            }
                        }
                        ...
                        Fonts.fontSFUI35.drawString(text, moduleElement.getX() + moduleElement.getWidth() + 6, moduleElement.slowlySettingsYPos + 3, 0xFF000000);
                        ...
                        Fonts.fontSFUI35.drawString(displayString, moduleElement.getX() + moduleElement.getWidth() + 6, moduleElement.slowlySettingsYPos + 2, Color.BLACK.getRGB());
                        ...
                        GlStateManager.resetColor();
                        Fonts.fontSFUI35.drawString(text, moduleElement.getX() + moduleElement.getWidth() + 6, moduleElement.slowlySettingsYPos + 4, 0xFF000000);
