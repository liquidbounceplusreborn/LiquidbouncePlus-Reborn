...
public class ColorPickerComponent extends ExpandableComponent implements PropertyComponent {
    ...
    public static WorldRenderer buffer = tessellator.getWorldRenderer();
    private final ColorValue colorSetting;
    private float hue;
    ...
    public ColorPickerComponent(Component parent, ColorValue colorSetting, int x, int y, int width, int height) {
        super(parent, colorSetting.getName(), x, y, width, height);

        this.colorSetting = colorSetting;

        Integer value = colorSetting.get();
    ...
    public void drawComponent(ScaledResolution scaledResolution, int mouseX, int mouseY) {
        ...
        Fonts.fontSFUI35.drawStringWithShadow(getName(), x + 2, y + height / 2F - 3, textColor);
        RenderUtils.drawSmoothRect(left, top, right, bottom, colorSetting.get());
        if (isExpanded()) {
            // Draw Background
            Gui.drawRect(x + Panel.X_ITEM_OFFSET, y + height, x + width - Panel.X_ITEM_OFFSET, y + getHeightWithExpand(), new Color(20, 20, 20, 160).getRGB());
            ...
            // Draw Color Picker
            {
                ...
                RenderUtils.drawRect(cpLeft, cpTop, cpRight, cpBottom, 0xFF000000);
            ...
            // Hue Slider
            {
                ...
                // Outline
                RenderUtils.drawRect(sLeft, sTop, sRight, sBottom, 0xFF000000);
                float inc = 0.2F;
                float times = 1 / inc;
                ...
                RenderUtils.drawRect(sLeft - outlineWidth,
                        csTop - outlineWidth,
                        sRight + outlineWidth,
                        csBottom + outlineWidth,
                        0xFF000000);
                RenderUtils.drawRect(sLeft,
                        csTop,
                        sRight,
                        csBottom,
