...
public class TextSetting extends Downward<TextValue>
{
    ...
    public void draw(final int mouseX, final int mouseY) {
        ...
        if (Fonts.fontTahoma.getStringWidth(this.textValue.getTextHovered() ? (this.textValue.get() + "_") : this.textValue.get()) > 70) {
            Fonts.fontTahoma.drawString(Fonts.fontTahoma.trimStringToWidth(this.textValue.getTextHovered() ? (this.textValue.get() + "_") : this.textValue.get(), 78, true), this.modulex + 5.0f + this.pos.x + 57.0f, this.moduley + 17.0f + this.texty + 13.0f, new Color(200, 200, 200).getRGB());
        }
