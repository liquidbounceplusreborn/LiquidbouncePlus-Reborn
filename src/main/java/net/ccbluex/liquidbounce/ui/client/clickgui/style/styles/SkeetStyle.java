...
public class SkeetStyle extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        int color39 = (new Color(ClickGUI.colorRedValue.get(), ClickGUI.colorGreenValue.get(), ClickGUI.colorBlueValue.get(), alpha)).getRGB();
        this.hue += 0.1F;
        ...
        for (int i = 0; i < LiquidBounce.moduleManager.getModuleInCategory(currentModuleType).size(); i++) {
            ...
            if (i >= moduleStart) {
                if (!module.getState()) {
                    ...
                    Fonts.fontSFUI35.drawString(module.getName(), startX + (isSettingsButtonHovered(startX + 100.0F, mY + 45.0F, startX + 200.0F, mY + 70.0F, mouseX, mouseY) ? 122 : 120), mY + 55.0F, (new Color(175, 175, 175, alpha)).getRGB());
                } else {
                    RenderUtils.drawRect(startX + 100.0F, mY + 45.0F, startX + 200.0F, mY + 70.0F, isSettingsButtonHovered(startX + 100.0F, mY + 45.0F, startX + 200.0F, mY + 70.0F, mouseX, mouseY) ? (new Color(60, 60, 60, alpha)).getRGB() : (new Color(35, 35, 35, alpha)).getRGB());
                    ...
                    Fonts.fontSFUI35.drawString(module.getName(), startX + (isSettingsButtonHovered(startX + 100.0F, mY + 45.0F, startX + 200.0F, mY + 70.0F, mouseX, mouseY) ? 122 : 120), mY + 55.0F, (new Color(255, 255, 255, alpha)).getRGB());
                }
        ...
        mY = startY + 12.0F;
        GameFontRenderer font = Fonts.fontSFUI35;
        for (int k = 0; k < currentModule.getValues().size() && mY <= startY + 250.0F; k++) {
            if (k >= valueStart) {
                ...
                if (value2 instanceof TextValue) {
                    ...
                    Fonts.fontSFUI40.drawString(textValue.getName() + ": " + textValue.get(), startX + 220.0F, mY + 50.0F, (new Color(175, 175, 175, alpha)).getRGB());
                    mY += 20.0F;
                }
                if (value2 instanceof BlockValue) {
                    BlockValue blockValue = (BlockValue)value2;
                    Fonts.fontSFUI40.drawString(blockValue.getName() + ": " + blockValue.get(), startX + 220.0F, mY + 50.0F, (new Color(175, 175, 175, alpha)).getRGB());
                    mY += 20.0F;
                }
                if (value2 instanceof FontValue) {
                    FontValue fontValue = (FontValue)value2;
                    Fonts.fontSFUI40.drawString(fontValue.getName() + ": " + fontValue.get(), startX + 220.0F, mY + 50.0F, (new Color(175, 175, 175, alpha)).getRGB());
                    mY += 20.0F;
                }
                if (value2 instanceof IntegerValue) {
                    ...
                    Fonts.fontSFUI40.drawString(floatValue.getName(), startX + 220.0F, mY + 50.0F, (new Color(175, 175, 175, alpha)).getRGB());
                    Fonts.fontSFUI40.drawString(floatValue.getValue().toString(), startX + 320.0F - font.getStringWidth(value2.getValue().toString()), mY + 50.0F, (new Color(255, 255, 255, alpha)).getRGB());
                    if (!Mouse.isButtonDown(0))
                        this.previousmouse = false;
                ...
                if (value2 instanceof FloatValue) {
                    ...
                    RenderUtils.drawRect(x + 2.0F, mY + 52.0F, (float)(x + render + 6.5D), mY + 53.0F, (new Color(35, 35, 255, alpha)).getRGB());
                    RenderUtils.drawFilledCircle(((float)(x + render + 2.0D) + 3.0F), mY + 52.25D, 1.5D, (new Color(35, 35, 255, alpha)).getRGB(), 5);
                    Fonts.fontSFUI40.drawString(floatValue2.getName(), startX + 220.0F, mY + 50.0F, (new Color(175, 175, 175, alpha)).getRGB());
                    Fonts.fontSFUI40.drawString(floatValue2.getValue().toString(), startX + 320.0F - font.getStringWidth(value2.getValue().toString()), mY + 50.0F, (new Color(255, 255, 255, alpha)).getRGB());
                    if (!Mouse.isButtonDown(0))
                        this.previousmouse = false;
                    if (isButtonHovered(x, mY + 45.0F, x + 100.0F, mY + 57.0F, mouseX, mouseY) && Mouse.isButtonDown(0)) {
                        if (!this.previousmouse && Mouse.isButtonDown(0)) {
                ...
                if (value2 instanceof BoolValue) {
                    ...
                    int xx = 50;
                    int x2x = 65;
                    Fonts.fontSFUI40.drawString(boolValue.getName(), startX + 220.0F, mY + 50.0F, (new Color(175, 175, 175, alpha)).getRGB());
                ...
                if (value2 instanceof ListValue) {
                    ...
                    float x = startX + 320.0F;
                    Fonts.fontSFUI40.drawString(listValue.getName(), startX + 220.0F, mY + 52.0F, (new Color(175, 175, 175, alpha)).getRGB());
                    ...
                    Fonts.fontSFUI40.drawString(listValue.get(), x + 40.0F - (font.getStringWidth(listValue.get()) / 2F), mY + 53.0F, (new Color(255, 255, 255, alpha)).getRGB());
        ...
        Fonts.fontSFUI40.drawString("Bind", startX + 220.0F, yyy + 50.0F, (new Color(170, 170, 170, alpha)).getRGB());
        ...
        Fonts.fontSFUI40.drawString(Keyboard.getKeyName(currentModule.getKeyBind()), x2 + 40.0F - (font.getStringWidth(Keyboard.getKeyName(currentModule.getKeyBind())) / 2F), yyy + 53.0F, (new Color(255, 255, 255, alpha)).getRGB());
        ...
        for (int i2 = 0; i2 < (ModuleCategory.values()).length; i2++) {
            ...
            Fonts.fontSFUI40.drawString(iterator[i2].toString(), xx2 + (isCategoryHovered(xx2 + 8.0F, k2 - 10.0F + 60.0F + (i2 * 45), xx2 + 80.0F, k2 + 20.0F + 60.0F + (i2 * 45), mouseX, mouseY) ? 27 : 25), k2 + 56.0F + (45 * i2), (new Color(255, 255, 255, alpha)).getRGB());
            try {
