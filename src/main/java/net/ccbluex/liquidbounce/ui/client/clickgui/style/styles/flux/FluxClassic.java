    ...
    public void drawScreen(int mouseX,int mouseY,float partialTicks) {
        ...
        for(final Module module : LiquidBounce.moduleManager.getModuleInCategory(this.currentCategory)) {
            if(!module.showSettings)
                ...
                module.yPos1 = 30;
                if(module.getName().equalsIgnoreCase("InfiniteAura"))
                    module.yPos1 += 10;
                if(module.getName().equalsIgnoreCase("InventoryManager"))
                    module.yPos1 += 15;
                ...
                for(int i = 0; i < module.getBooleanValues().size(); ++i) {
                    ...
                    if(i == 0) {
                        ...
                        if(module.getName().equalsIgnoreCase("CivBreak"))
                            valuePosY += 20;
                        if(module.getName().equalsIgnoreCase("NameTags"))
                            valuePosY += 10;
        ...
        if(showConfig) {
            ...
            for (int index = 0;index < LiquidBounce.fileManager.profilesConfigs.size(); ++index) {
                ...
                Fonts.fontSFUI35.drawStringWithColor("§妈x", width - 75, height - 3F - posY + yPos1, new Color(160,160,160).getRGB(), false);
                Fonts.fontSFUI35.drawStringWithColor("§妈" + config.getFile().getName().split(".profile")[0], width - 75F + Fonts.fontSFUI35.getCharWidth('v') + 2, height - 4F - posY + yPos1, new Color(160,160,160).getRGB(), false);
            }
        }
        Fonts.fontSFUI35.drawStringWithColor("§妈v",width - 75, height - 22 - posY, new Color(160,160,160).getRGB(), false);
        Fonts.fontSFUI35.drawStringWithColor("§妈u", width - 20, height - 22 - posY, new Color(160,160,160).getRGB(), false);
        Fonts.fontSFUI35.drawStringWithColor("§妈#" + currentConfigName, width - 75F + Fonts.fontSFUI35.getCharWidth('v') + 2, height - 23F - posY, new Color(160,160,160).getRGB(), false);
