...
public class AstolfoStyle extends Style {
    ...
    public void drawDescription(int mouseX, int mouseY, String text) {
        ...
        GlStateManager.resetColor();
        Fonts.minecraftFont.drawString(text.toLowerCase(), mouseX + 12, mouseY + (Fonts.minecraftFont.FONT_HEIGHT / 2), Integer.MAX_VALUE);
    }
    ...
    public void drawButtonElement(int mouseX, int mouseY, ButtonElement buttonElement) {
        ...
        GlStateManager.resetColor();
        Fonts.minecraftFont.drawString(buttonElement.getDisplayName().toLowerCase(), buttonElement.getX() + 3,
    ...
    public void drawModuleElement(int mouseX, int mouseY, ModuleElement moduleElement) {
        ...
        GlStateManager.resetColor();
        Fonts.minecraftFont.drawString(moduleElement.getDisplayName().toLowerCase(), moduleElement.getX() + 3,
                moduleElement.getY() + 7, Integer.MAX_VALUE);

        final List<Value<?>> moduleValues = moduleElement.getModule().getValues();

        if (!moduleValues.isEmpty()) {
            Fonts.minecraftFont.drawString("+", moduleElement.getX() + moduleElement.getWidth() - 8,
            ...
            if (moduleElement.isShowSettings()) {
                ...
                for (final Value value : moduleValues) {
                    if (value instanceof BoolValue) {
                        ...
                        GlStateManager.resetColor();
                        Fonts.minecraftFont.drawString(text.toLowerCase(), moduleElement.getX() + moduleElement.getWidth() + 6,
                        ...
                        RenderUtils.drawRect(moduleElement.getX() + moduleElement.getWidth() + 4, yPos + 2, moduleElement.getX() +
                                moduleElement.getWidth() + moduleElement.getSettingsWidth(), yPos + 14, new Color(26, 26, 26).getRGB());
                        GlStateManager.resetColor();
                        Fonts.minecraftFont.drawString("§c" + text.toLowerCase(), moduleElement.getX() + moduleElement.getWidth() + 6, yPos + 4, 0xffffff);
                        Fonts.minecraftFont.drawString(listValue.openList ? "-" : "+", (int) (moduleElement.getX() + moduleElement.getWidth() +
                        ...
                        for (final String valueOfList : listValue.getValues()) {
                            ...
                            if (listValue.openList) {
                                ...
                                GlStateManager.resetColor();
                                Fonts.minecraftFont.drawString(">", moduleElement.getX() +
                                        moduleElement.getWidth() + 6, yPos + 4, Integer.MAX_VALUE);
                                Fonts.minecraftFont.drawString(valueOfList.toLowerCase(), moduleElement.getX() + moduleElement.getWidth() + 14,
                        ...
                        GlStateManager.resetColor();
                        Fonts.minecraftFont.drawString(text.toLowerCase(), moduleElement.getX() + moduleElement.getWidth() + 6, yPos + 4, 0xffffff);
                        yPos += 22;
